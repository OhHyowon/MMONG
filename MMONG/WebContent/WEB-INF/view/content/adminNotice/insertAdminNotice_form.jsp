...
<div class="col-lg-10">
	<div class="form-panel">
        ...
        <form id="insert" action="/MMONG/adminNotice/insertAdminNotice.do" method="post" >
                ...
                제목:
             	   <input class="form-control" type="text" id="title" placeholder="제목을 입력하세요." name="title"/><br>
                내용: 
              	 <textarea class="form-control" cols="80" rows="10" id="content" placeholder="내용을 입력하세요." name="content"></textarea><br>
	                <div id="view-menu">
