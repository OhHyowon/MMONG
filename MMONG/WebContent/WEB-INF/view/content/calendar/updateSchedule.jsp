...
<table>
	...
	<tr>
		...
		<td style="width: 300px;padding:0px 0px 0px 20px;"><input type="text" name="title" style="width:237.5px; height:30px;" id="title" maxlength="50" value="${requestScope.updateInfo.title }">
	...
	<tr style="line-height:30px;">
		<th>메모</th>
		<td style="width: 300px;padding:10px 0px 0px 20px;"><input type="text" name="content" style="width:237.5px; height:80px;"id="content" maxlength="100" value="${requestScope.updateInfo.content }">
